...
//
//     final secondTokenModel = secondTokenModelFromJson(jsonString);

import 'dart:convert';

SecondTokenModel secondTokenModelFromJson(String str) => SecondTokenModel.fromJson(json.decode(str));

String secondTokenModelToJson(SecondTokenModel data) => json.encode(data.toJson());
...
class SecondTokenModel {
  ...
  factory SecondTokenModel.fromJson(Map<String, dynamic> json) => SecondTokenModel(
    id: json["id"],
