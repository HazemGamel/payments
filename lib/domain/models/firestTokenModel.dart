...
//
//     final firestTokenModel = firestTokenModelFromJson(jsonString);

import 'dart:convert';

FirestTokenModel firestTokenModelFromJson(String str) => FirestTokenModel.fromJson(json.decode(str));

String firestTokenModelToJson(FirestTokenModel data) => json.encode(data.toJson());

class FirestTokenModel {
  FirestTokenModel({
  ...
  factory FirestTokenModel.fromJson(Map<String, dynamic> json) => FirestTokenModel(
